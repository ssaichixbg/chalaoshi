...
class MsgLog(models.Model):
    ...
    def __unicode__(self):
        return '%s %s' % (self.id, self.to_user)
...
class WeixinGroup(models.Model):
    ...
    name = models.CharField(max_length=30, blank=True, verbose_name='组名')
...
class WeixinUser(models.Model):
    ...
    openid = models.CharField(max_length=40, unique=True, verbose_name='OpenID')
